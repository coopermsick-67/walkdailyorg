...
export default function ReadingPlansPage() {
  ...
  const handleResetProgress = useCallback(() => {
    if (!selectedPlan) return;
    localStorage.removeItem(`reading-progress-${selectedPlan.id}`);
    setCompletedSet(new Set());
    setReadingDays((prev) => prev.map((d) => ({ ...d, completed: false })));
    setCurrentStreak(0);
  ...
  return (
    <div className="flex-1 flex flex-col max-w-3xl mx-auto w-full">
      ...
      <ConfirmModal
        ...
        message="Reset all progress for this reading plan? This cannot be undone."
        confirmLabel="Reset"
        cancelLabel="Cancel"
        variant="danger"

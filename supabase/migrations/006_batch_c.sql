-- Batch C: profiles columns + verse_marks + reading_progress + journal_entries
-- + prayer tables + ai_usage + verse_memory + daily_verses + chat_messages
-- + prayer_flags + daily_devotionals + push_subscriptions + reading_plans
-- + reading_plan_days + groups + group_members + RPCs
